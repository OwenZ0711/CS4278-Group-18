...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "https://frontend2-pmgrakhev-sihan-yes-projects.vercel.app"}},
...
def get_playlists():
    ...
    return redirect("https://frontend2-pmgrakhev-sihan-yes-projects.vercel.app", code=302)
