...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "https://frontend2-epslw0w82-sihan-yes-projects.vercel.app"}},
...
def get_playlists():
    ...
    return redirect("https://frontend2-epslw0w82-sihan-yes-projects.vercel.app/my-artist", code=302)
