...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "https://frontend2-lzg2vmas0-sihan-yes-projects.vercel.app"}},
...
def get_playlists():
    ...
    return redirect("https://frontend2-lzg2vmas0-sihan-yes-projects.vercel.app", code=302)
